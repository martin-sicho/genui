# Generated by Django 2.2.8 on 2020-01-14 15:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mode', models.CharField(choices=[('classification', 'Classification'), ('regression', 'Regression')], max_length=32)),
                ('algorithm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qsar.Algorithm')),
                ('fileFormat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qsar.ModelFileFormat')),
                ('parameters', models.ManyToManyField(to='qsar.ModelParameterValue')),
        ...
        migrations.AddField(
            model_name='modelperformance',
            name='model',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='performance', to='qsar.Model'),
        ),
        migrations.AddField(
            model_name='modelperformance',
        ...
        migrations.AddField(
            model_name='model',
            name='trainingStrategy',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qsar.TrainingStrategy'),
        ),
        migrations.AddField(
            model_name='model',
            name='validationStrategy',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qsar.ValidationStrategy'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activities', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='model', to='qsar.ModelActivitySet')),

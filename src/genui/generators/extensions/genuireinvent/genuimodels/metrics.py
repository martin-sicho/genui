...
#     modes = [Algorithm.GENERATOR]
#     algorithms = [algorithms.ReinventAgent]
#
#     def __call__(self, true_vals: Series, predicted_vals: Series):
#         # TODO: implement this
#         raise NotImplementedError("This is not yet supported.")
...
#
#     def __call__(self, true_vals: Series, predicted_vals: Series):
#         raise NotImplementedError("This method is not intended to be called, because Reinvent has this calculation built in.")
#
# class ReinventLoss(ValidationMetric):
#     name = "DrExLoss"
#     description = "Value of the Reinvent loss function."
#     modes = [Algorithm.GENERATOR]
#
#     def __call__(self, true_vals: Series, predicted_vals: Series):
#         raise NotImplementedError("This method is not intended to be called, because Reinvent has this calculation built in.")
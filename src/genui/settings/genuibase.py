...
GENUI_SETTINGS = {
    ...
    'FILES_DIR' : os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../files/')) if 'GENUI_FILES_DIR' not in os.environ else os.path.abspath(os.environ['GENUI_FILES_DIR']),
